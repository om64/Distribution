 ...
 *
 * Generation date: 2016/05/19 10:48:39
 */
class Version20160519104838 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("
            CREATE TABLE media_resource_options (
                id INT AUTO_INCREMENT NOT NULL, 
                showActiveView TINYINT(1) DEFAULT '1' NOT NULL, 
                showAutoPauseView TINYINT(1) DEFAULT '0' NOT NULL, 
                showLiveView TINYINT(1) DEFAULT '0' NOT NULL, 
                showExerciseView TINYINT(1) DEFAULT '0' NOT NULL, 
                showRegionNote TINYINT(1) DEFAULT '0' NOT NULL, 
