...
(function () {
    ...
    $('#widgets-section').on('click', '#create-widget-instance', function () {
        window.Claroline.Modal.displayForm(
            Routing.generate(
                ...
                {'homeTab': currentHomeTabId, 'homeTabType': homeTabType}
            ),
            addWidget,
            function() {}
        );
    ...
    $('#widgets-list-panel').on('click', '.edit-widget-btn', function () {
        ...
        window.Claroline.Modal.displayForm(
            Routing.generate(
                'claro_admin_widget_config_edit_form',
                {
    ...
    var updateWidget = function (datas) {
        ...
        if (lock === 'locked') {
            $('#widget-element-lock-' + id).removeClass('hidden');
        } else {
            $('#widget-element-lock-' + id).addClass('hidden');
        }
    };
})();
